  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <p class="lead">Use this tool as a word search in the clue with all spaces removed and extra points to move. <?php if($_GET['spoken'] == 1){ echo "<a href='{$_SERVER['PHP_SELF']}' class='btn btn-primary btn-sm'>Original Spoken Clue</a>"; } else { echo "<a href='{$_SERVER['PHP_SELF']}?spoken=1' class='btn btn-primary btn-sm'>Original Subtile Clue</a>"; } ?></p>
      </div>
      ...
      <div class="col-md-12">
        ...
        <div class="alert alert-info">
          ...
          <p>
            <a href="wordsearch.php" class="btn btn-primary btn-sm">Original Grid</a>
